// provides: double str_to_double (const char *, char **)
// provides: double str_to_float (const char *)
// requires: ctype/isdigit.c
// requires: ctype/isspace.c
// comment: alias strtod, and atof as str_to_float 
...
double str_to_double (const char *nptr, char **endPtr) {
 /* nptr: A decimal ASCII floating-point number,
...
double str_to_float (const char* str) {
  return str_to_double (str, (char **) NULL);
}
